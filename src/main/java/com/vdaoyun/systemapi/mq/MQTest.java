...
public class MQTest {
	...
	public void sendDeviceRecordData() {
		...
		item.setSolarVoltage(18.2);
		item.setBatteryVoltage(35.6);
		item.setBatteryTemperature(45.3);
		item.setSystemTemperature(35.6);
		item.setBatteryLevel(97);
		item.setShellTemperature(36.3);
		item.setGPS("9.5080440.0,3025.9864N,11424.8529E,2.1,56.0,2,92.23,0.0,0.0,140518,08");
		item.setPowerKey("7.22018-5-25 02:25:56");
		...
		record.setData(data);
		SendMessage(MQTopic.DEVICE_TOPIC, record);
	}
